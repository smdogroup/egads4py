...
cdef extern from "egadsTypes.h":
    ...
    enum:
        ...
        # /* ATTRIBUTE TYPES */
        EGADS_ATTRINT"ATTRINT"
        EGADS_ATTRREAL"ATTRREAL"
        EGADS_ATTRSTRING"ATTRSTRING"
        EGADS_ATTRCSYS"ATTRCSYS"

        # /* SOLID BOOLEAN OPERATIONS */
        EGADS_SUBTRACTION"SUBTRACTION"
        EGADS_INTERSECTION"INTERSECTION"
        EGADS_FUSION"FUSION"
        ...
        # /* FACE SOURCE TYPES */
        EGADS_NODEOFF"NODEOFF"
        EGADS_EDGEOFF"EDGEOFF"
        EGADS_FACEDUP"FACEDUP"
